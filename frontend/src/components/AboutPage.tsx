...
const AboutPage: React.FC = () => {
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8 text-center text-text-primary">About RoomSync</h1>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="bg-gray-800 rounded-2xl p-8 border border-gray-700 shadow-lg">
          ...
          <div className="space-y-6">
            ...
            <div>
              <h3 className="font-semibold text-lg mb-2 text-text-primary">Problem Statement</h3>
              <p className="text-gray-300 leading-relaxed">
            ...
            <div>
              <h3 className="font-semibold text-lg mb-2 text-text-primary">Solution</h3>
              <p className="text-gray-300 leading-relaxed">
            ...
            <div>
              <h3 className="font-semibold text-lg mb-2 text-text-primary">Key Features</h3>
        ...
        <div className="bg-gray-800 rounded-2xl p-8 border border-gray-700 shadow-lg">
          ...
          <div className="space-y-6">
            {teamMembers.map((member, idx) => (
              <div key={idx} className="p-4 rounded-xl bg-brand-secondary/50 border border-cyber-border">
